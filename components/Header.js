  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 className="text-3xl ssm:text-[10px] px-0">
            <Link href="/">EtherSneakers</Link>
          </h2>
                ...
                <a
                  className={
                    currentRoute === "/dashboard"
                      ...
                      : "text-gray-500 font-medium px-10 text-xl hover:text-white"
                  }
                >
                  Home
                </a>
                ...
                <a
                  className={
                    currentRoute === "/createnft"
                      ...
                      : "text-gray-500 font-normal px-10 text-xl hover:text-white"
                  }
                >
