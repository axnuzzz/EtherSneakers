  ...
  return (
    <div className="">
      ...
      <div className="relative overflow-hidden">
        ...
        <section className="max-w-[1240px] my-20 mx-auto grid grid-cols-2  gap-2 font-body h-[540px] overflow-hidden top-7 md:gap-12 medium md:px-5 sm:grid-cols-1 sm:h-full relative ">
          <div className="flex flex-col items-start justify-center h-full sm:items-center">
            <h1 className="w-full text-4xl sm:text-center">
              Discover a New Era of <br /> Sneakers
            </h1>
            <p className="text-[#ADB9C7] sm:text-center">
              EtherSneakers is the latest and the best place to buy/sell your
              favourite sneaker at the best available price. Sneakers have been
              sold for a long time, but never like this.
            </p>
            {addr ? (
              <button
                type="button"
              ...
              >
                <Link href="/createsneaker">
                  <a className={"text-black-500 font-normal hover:text-white"}>
                    Create a Sneaker Sale
                  </a>
                </Link>
              </button>
            ) : (
        ...
        <section className="max-w-[1240px] my-20 mx-auto  gap-2 font-body top-7 ">
          <h2 className="sm:text-center md:mx-10">Featured Sneakers </h2>
